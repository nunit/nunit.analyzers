namespace NUnit.Analyzers.WithinUsage
{
    internal static class WithinUsageAnalyzerConstants
    {
        ...
        internal const string Description = "The Within modifier should only be used for numeric or Date/Time arguments or tuples containing only these element types. Using it on another type will not have any effect.";
    }
}
