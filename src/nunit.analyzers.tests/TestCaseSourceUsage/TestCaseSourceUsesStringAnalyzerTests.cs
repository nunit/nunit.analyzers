...
#pragma warning restore CS0414
    ...
    class AnotherClass
    {
        ...
        public static class TestData
        {
            ...
            var testDataReference = BinaryReference.Compile(testDataCode);

            var solution = CodeFactory.CreateSolution(testCode, Settings.Default.WithMetadataReferences(
                Settings.Default.MetadataReferences!.Append(testDataReference)));
