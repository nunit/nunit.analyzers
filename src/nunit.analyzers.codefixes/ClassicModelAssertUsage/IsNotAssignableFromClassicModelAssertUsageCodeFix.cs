...
namespace NUnit.Analyzers.ClassicModelAssertUsage
{
    ...
    [Shared]
    public sealed class IsNotAssignableFromClassicModelAssertUsageCodeFix
        : ClassicModelAssertUsageCodeFix
    {
        public override ImmutableArray<string> FixableDiagnosticIds { get; } = ImmutableArray.Create(AnalyzerIdentifiers.IsNotAssignableFromUsage);
