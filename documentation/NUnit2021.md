...
| Enabled  | True
| Category | Assertion
| Code     | [EqualToIncompatibleTypesAnalyzer](https://github.com/nunit/nunit.analyzers/blob/master/src/nunit.analyzers.common/EqualToIncompatibleTypes/EqualToIncompatibleTypesAnalyzer.cs)
